---
title: Access the Office add-ins from the Home tab and File Menu
description: Access the Office add-ins from the Home tab and File Menu
slug: /MC475168
sidebar_label: MC475168
