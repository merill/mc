---
title: Admins can select the domain to use for Teams Email Service
description: Admins can select the domain to use for Teams Email Service
slug: /MC705761
sidebar_label: MC705761
