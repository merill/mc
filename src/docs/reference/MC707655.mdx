---
title: Teams admin center (TAC) Header Search now supports Emergency Addresses
description: Teams admin center (TAC) Header Search now supports Emergency Addresses
slug: /MC707655
sidebar_label: MC707655
