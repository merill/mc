---
title: Microsoft Edge to replace built-in PDF engine with Adobe Acrobat PDF engine
description: Microsoft Edge to replace built-in PDF engine with Adobe Acrobat PDF engine
slug: /MC512918
sidebar_label: MC512918
