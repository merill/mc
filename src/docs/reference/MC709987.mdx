---
title: Introducing the ability to duplicate an existing town hall
description: Introducing the ability to duplicate an existing town hall
slug: /MC709987
sidebar_label: MC709987
