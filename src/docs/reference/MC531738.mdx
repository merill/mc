---
title: Launching new way to open links in Edge from Outlook for iOS and Android
description: Launching new way to open links in Edge from Outlook for iOS and Android
slug: /MC531738
sidebar_label: MC531738
