---
title: Whiteboard - existing Azure board migration to ODB storage
description: Whiteboard - existing Azure board migration to ODB storage
slug: /MC677236
sidebar_label: MC677236
