---
title: Banner message to appear for Stream (Classic) users on migrated videos
description: Banner message to appear for Stream (Classic) users on migrated videos
slug: /MC678059
sidebar_label: MC678059
